...
namespace Watcher
{
    public class Program
    {
        ...
        public static readonly string HostAssyTemp = new DirectoryInfo("../Temp").FullName;
        ...
        private static readonly string ServerProjectName = @$"{nameof(MyBlazorInAction02)}.Server";
        private static readonly string ServerProjectPath = new DirectoryInfo("../Server").FullName;
